...
class ImportMappingDoctrineCommand extends DoctrineCommand
{
    ...
    protected function configure()
    {
        $this
            ...
            ->addArgument('destination-path', InputArgument::REQUIRED, 'The path to import the mapping information into')
            ->addArgument('mapping-type', InputArgument::OPTIONAL, 'The mapping type to export the imported mapping information to')
            ->addOption('namespace', null, InputOption::VALUE_REQUIRED, 'The namespace to use for generated entities', 'Simplr')
